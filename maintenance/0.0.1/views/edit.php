<div class="container">
	...
	<p>
		Le site est actuellement en mode privé. <a class="btn btn-primary" href="<?php echo base_url('maintenance/configure/turnoff'); ?>"><i class="fa fa-ok"></i> Désactiver le mode privé</a>
	</p>
	<?php else: ?>
	<p>
